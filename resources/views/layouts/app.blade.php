    ...
    <div class="flex min-h-screen" x-data="{ sidebarOpen: false }">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto">
                ...
                <a href="{{ route('admin.chairman') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition-all duration-200 {{ request()->routeIs('admin.chairman') ? 'bg-white/15 text-white font-semibold shadow-lg shadow-green-900/20' : 'text-green-200 hover:bg-white/10 hover:text-white' }}">
